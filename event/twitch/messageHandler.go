...
// message.
func MessageHandler(t *twitchgo.IRCSession, channel string, user *twitchgo.IRCUser, message string) {
...
func HandleCmdJoin(t *twitchgo.IRCSession, channel string, user *twitchgo.IRCUser, args []string) {
...
func HandleCmdTickets(t *twitchgo.IRCSession, channel string, source *twitchgo.IRCUser, args []string) {
	channel, _ = strings.CutPrefix(channel, "#")
	const tp = tp + "tickets."
...
func HandleCmdDraw(t *twitchgo.IRCSession, channel string, user *twitchgo.IRCUser, args []string) {
	channel, _ = strings.CutPrefix(channel, "#")
	const tp = tp + "draw."
